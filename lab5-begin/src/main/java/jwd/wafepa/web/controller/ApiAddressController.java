...
public class ApiAddressController {
	...
	public ResponseEntity<AddressDTO> add(@RequestBody AddressDTO newAddress, @PathVariable Long userId) {
	...
	public ResponseEntity<AddressDTO> edit(@PathVariable Long id, @RequestBody AddressDTO editedAddress,
	...
	public ResponseEntity<AddressDTO> delete(@PathVariable Long id, @PathVariable Long userId) {

		Address toDelete = addressService.findOne(id);
		if (toDelete == null || !userId.equals(toDelete.getUser().getId())) {
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
		}
