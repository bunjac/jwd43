...
public class ApiActivityController {
	...
	ResponseEntity<List<ActivityDTO>> getActivities(@RequestParam(value = "name", required = false) String name) {
	...
	public ResponseEntity<ActivityDTO> add(@Validated @RequestBody ActivityDTO newActivity) {
